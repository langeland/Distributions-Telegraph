 ...
 */
class Version20180430211519 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE langeland_telegraphcore_domain_model_telegram (identifier VARCHAR(255) NOT NULL, telegraph VARCHAR(255) DEFAULT NULL, created DATETIME NOT NULL, printed DATETIME DEFAULT NULL, channel VARCHAR(255) NOT NULL, instant TINYINT(1) NOT NULL, tag VARCHAR(255) DEFAULT NULL, message LONGTEXT NOT NULL, messageencoded LONGBLOB NOT NULL, INDEX IDX_49EFCCFE8056211 (telegraph), PRIMARY KEY(identifier)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
